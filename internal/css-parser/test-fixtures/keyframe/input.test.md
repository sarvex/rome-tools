				...
				value: Array [
					CSSKeyframeBlock {
						name: CSSKeyframeSelector {
							value: CSSRaw {
								value: "from"
								loc: SourceLocation keyframe/input.css 2:1-2:1
							}
					...
					CSSKeyframeBlock {
						name: CSSKeyframeSelector {
							value: CSSRaw {
								value: "to"
								loc: SourceLocation keyframe/input.css 3:1-3:1
							}
					...
					CSSKeyframeBlock {
						name: CSSKeyframeSelector {
							value: CSSPercentage {
								value: 15
								loc: SourceLocation keyframe/input.css 4:1-4:1
							}
					...
					CSSKeyframeBlock {
						name: CSSKeyframeSelector {
							value: CSSPercentage {
								value: 0
								loc: SourceLocation keyframe/input.css 5:1-5:1
							}
					...
					CSSKeyframeBlock {
						name: CSSKeyframeSelector {
							value: CSSPercentage {
								value: 100
								loc: SourceLocation keyframe/input.css 6:1-6:1
							}
		...
		CSSAtRule {
			...
			block: CSSKeyframe {
				name: CSSKeyframeName {
					value: CSSString {
						value: "foo"
						loc: SourceLocation keyframe/input.css 9:11-9:11
					}
		...
		CSSAtRule {
			...
			block: CSSKeyframe {
				name: CSSKeyframeName {
					value: CSSString {
						value: "Initial"
						loc: SourceLocation keyframe/input.css 13:11-13:11
					}
